<template>
    ...
    <AdminLayout>
        <h1 class="text-2xl font-bold mb-6">Create Network Profile</h1>
        <form @submit.prevent="submit">
            ...
            <Link href="/admin/network-profiles" class="px-4 py-2.5 bg-gray-600 text-white rounded-md ml-3" role="button">
                Cancel
            </Link>
        </form>
    </AdminLayout>
