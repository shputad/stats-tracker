    ...
    <AdminLayout>
        <div class="mx-auto">
            ...
            <form @submit.prevent="submit" class="bg-white p-6 shadow rounded">
                <!-- Custom Command -->
                <div class="mb-4">
                    <label for="custom_command" class="block text-gray-700 font-medium">
                        Custom Command
                    </label>
                    <textarea id="custom_command" class="mt-1 block w-full border border-gray-300 rounded-md p-2"
                        v-model="form.custom_command"></textarea>
                </div>

                <!-- File URL -->
                <div class="mb-4">
                    <label for="file_url" class="block text-gray-700 font-medium">
                        File URL
                    </label>
                    <input v-model="form.file_url" type="text" id="file_url" placeholder="Enter the file URL"
                ...
                <div class="mb-4">
                    <label for="obfuscation_technique" class="block text-gray-700 font-medium">
                        Obfuscation Technique
                    </label>
                    <select id="obfuscation_technique" class="mt-1 block w-full border border-gray-300 rounded-md p-2"
                ...
                <!-- Generated Command -->
                <div class="mb-4">
                    <label for="generated_command" class="block text-gray-700 font-medium">
                        Generated Command
                    </label>
                    <textarea id="generated_command" class="mt-1 block w-full border border-gray-300 rounded-md p-2"
                        readonly :value="generatedCommand"></textarea>
                </div>

                <!-- Test Output -->
                <div v-if="testOutput" class="mb-4 p-4 bg-blue-100 text-blue-700 rounded">
                    <h2 class="font-bold mb-2">Test Output:</h2>
                    <pre class="max-w-full whitespace-pre-wrap break-all"
                        style="word-break: break-all; overflow-wrap: anywhere;">{{ testOutput }}</pre>
                </div>
                ...
                <div class="flex flex-col sm:flex-row gap-4">
                    ...
                    <button type="button" @click="exportCommand"
                        class="px-4 py-2 bg-green-600 text-white rounded-md hover:bg-green-700">
                        Export to File
                    </button>
                    <button type="button" @click="testCommand"
...
// Refs for generated command and test output
