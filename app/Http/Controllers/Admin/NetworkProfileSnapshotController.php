...
class NetworkProfileSnapshotController extends Controller
{
    ...
    public function index(NetworkProfile $networkProfile, Request $request)
    {
        ...
        return Inertia::render('Admin/NetworkProfiles/Snapshots/Index', [
    ...
    {
        return Inertia::render('Admin/NetworkProfiles/Snapshots/Create', [
            'profile' => $networkProfile->load('networkChannel')
        ]);
    }
    ...
    public function store(Request $request, NetworkProfile $networkProfile)
    {
        ...
        return redirect()->route('admin.network-profiles.snapshots.index', $networkProfile->id)
    ...
    {
        return Inertia::render('Admin/NetworkProfiles/Snapshots/Show', [
    ...
    {
        return Inertia::render('Admin/NetworkProfiles/Snapshots/Edit', [
            'profile' => $networkProfile->load('networkChannel'),
            'snapshot' => $snapshot
        ]);
    }
